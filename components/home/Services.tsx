      ...
      <Container>
        ...
        <div className="mt-9 grid items-stretch gap-4 sm:mt-10 sm:grid-cols-2 lg:grid-cols-3">
          {services.map(({ title, description, icon: Icon }) => (
            <article key={title} className="group flex h-full min-w-0 flex-col rounded-[26px] border border-black/8 bg-white p-6 shadow-[0_14px_40px_rgba(23,23,23,0.05)] transition duration-300 hover:-translate-y-0.5 hover:border-black/12 hover:shadow-lift">

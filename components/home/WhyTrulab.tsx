...
export default function WhyTrulab() {
  return (
    <Section id="why-trulab" className="bg-trulab-surface">
      <Container className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
        ...
        <div className="grid min-w-0 gap-3">
          {whyTrulabContent.points.map((point) => (
            <div key={point} className="flex min-w-0 gap-4 rounded-2xl border border-trulab-border/8 bg-trulab-bg p-4 transition duration-200 hover:border-trulab-border/12 hover:bg-trulab-surface hover:shadow-sm">

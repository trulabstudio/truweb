...
export default function Certifications() {
  return (
    <Section className="bg-trulab-surface">
      <Container>
        <div className="rounded-[28px] border border-trulab-border/8 bg-trulab-bg p-5 shadow-soft sm:rounded-[32px] sm:p-10">
          ...
          <div className="mt-8 grid items-stretch gap-4 sm:grid-cols-3">
            {certifications.map((item) => (
              <article key={item.title} className="flex h-full min-w-0 flex-col rounded-3xl border border-trulab-border/8 bg-trulab-surface p-6 transition duration-200 hover:border-trulab-border/12 hover:shadow-sm">
